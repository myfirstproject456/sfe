...
//                             alert("chart data: " + JSON.stringify(obj));
                         }else if(obj.id == 4){
                             obj.color = red;
                         }else if(obj.id == 5){
                             obj.color = red;
                     ...
                     pieChart.tooltip.contentGenerator(function(d) {
                         var html = "";
                     ...
                     pieChart.pie.dispatch.on("elementClick", function(e) {
                         ...
                         // window.location.href = '/getfilterservices';
...
//        }
//    var pieChartData = [
//        { 'label': 'Pending','id' : '4','value' : 29, 'color': red }, 
//        { 'label': 'WIP', 'id' : '5','value' : 40, 'color': orange }, 
//        { 'label': 'Closed', 'id' : '6','value' : 32, 'color': green }, 
//        { 'label': 'Raised', 'id' : '3','value' : 100, 'color': purpleLight }, 
//    ];
